...
class ItemRepositoryTest {
    ...
    public void findByItemNmTest(){
        this.createItemList();
        List<Item> itemList = repository.findByItemNm("테스트상품1");
    ...
    public void findByItemNmOrItemDetailTest(){
        this.createItemTest();
        List<Item> itemList =
                repository.findByItemNmOrItemDetail("테스트 상품1", "테스트 상품 상세 설명5");
        for (Item item: itemList){
            System.out.println(item.toString());
        }
    }
...
//        this.createItemTest();
//        List<Item> itemList = repository.findByItemDetail("테스트 상품 상세 설명");
//        for (Item item:itemList){
//            System.out.println(item.toString());
//        }
//    }
